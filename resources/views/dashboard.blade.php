...
<head>
    ...
    <!-- summernote -->
    <link rel="stylesheet" href="{{ asset('javascript/plugins/summernote/summernote-bs4.min.css') }}">
    <!-- summernote -->
    ...
    <link rel="stylesheet" href="{{ asset('javascript/plugins/select2/css/select2.min.css') }}">
    <link rel="stylesheet"
        href="{{ asset('javascript/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css') }}">
