            ...
            <div class="table-responsive" style="overflow-y: scroll; max-height: 470px; border-top-left-radius: 20px;">
                <table class="table" id="table_efectiveness">
                    <thead class="thead-dark" style="width: 100%; border-collapse: collapse;">
                        ...
                        <tr>
                            <th style="position: sticky; top: 0; z-index: 1;"><center><br>Nombre/Cédula<br><i class="fa-solid fa-signature"></i></center></th>
                            <th style="position: sticky; top: 0; z-index: 1;"><center>Total Ponderado<br><i class="fa-solid fa-chart-simple"></i></center></th>
                            @foreach ($atributos as $atributo)
                                <th style="position: sticky; top: 0; z-index: 1;">
                                    <center><i class="fa-brands fa-creative-commons-by"></i>&nbsp;&nbsp;{{ $atributo['nombre_atributo'] }} <br> <span
    ...
    <div class="modal-dialog">
        <div class="modal-content">
                    ...
                    <div class="col-sm">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="selector_atribute">
                                ...
                                @foreach ($atributos as $atributo)
                                <option value="{{ $atributo["id_atributo"]}}">{{ $atributo["nombre_atributo"]}}</option>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info" onclick="editAtriubte('{{route('editPorcentaje')}}')">Cambiar porcentaje</button>
                <button type="button" class="btn btn-danger" onclick="deleteAtribute('{{route('deleteAtribute')}}')">Eliminar Atributo</button>
                <button type="button" class="btn btn-primary" onclick="insertAtribute('{{ route('insertAtribute') }}')">Enviar</button>
            </div>
        </div>
    </div>
</div>
